...
# Data specific modifications for uid___A002_X8602fa_Xc3
# - additional flagging of a bad antenna, PM02
# - skipping PM02 in processing.
...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_X8602fa_Xc3.ms') == False:
    importasdm('uid___A002_X8602fa_Xc3', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=False, lazy=False, process_caldevice=False, with_pointing_correction=True)
    os.system(os.environ['CASAPATH'].split()[0] + '/bin/bdflags2MS -f "COR DELA INT MIS SIG SYN TFB WVR ZER" uid___A002_X8602fa_Xc3 uid___A002_X8602fa_Xc3.ms')
  if applyonly != True: es.fixForCSV2555('uid___A002_X8602fa_Xc3.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X8602fa_Xc3.ms.listobs')
  listobs(vis = 'uid___A002_X8602fa_Xc3.ms',
    listfile = 'uid___A002_X8602fa_Xc3.ms.listobs')
  
  if applyonly != True:
    aU.getTPSampling(vis = 'uid___A002_X8602fa_Xc3.ms', showplot = True, plotfile = 'uid___A002_X8602fa_Xc3.ms.sampling.png')
    for i in ['PM02', 'PM03', 'PM04']:
      aU.getTPSampling(vis = 'uid___A002_X8602fa_Xc3.ms', antenna = i, showplot = True, plotfile = 'uid___A002_X8602fa_Xc3.ms.sampling.'+i+'.png')
...
if(mystep in thesteps):
  ...
  flagcmd(vis = 'uid___A002_X8602fa_Xc3.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_X8602fa_Xc3.ms.flagcmd.png')
  ...
  flagdata(vis = 'uid___A002_X8602fa_Xc3.ms', antenna='PM02&&&')
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X8602fa_Xc3.ms.tsys')
  
  gencal(vis = 'uid___A002_X8602fa_Xc3.ms',
    caltable = 'uid___A002_X8602fa_Xc3.ms.tsys',
    caltype = 'tsys')
  
  plotbandpass(caltable='uid___A002_X8602fa_Xc3.ms.tsys', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='92.1875%',showfdm=True, 
    field='', figfile='uid___A002_X8602fa_Xc3.ms.tsys.plots.overlayTime/uid___A002_X8602fa_Xc3.ms.tsys') 
  
  if applyonly != True: es.checkCalTable('uid___A002_X8602fa_Xc3.ms.tsys', msName='uid___A002_X8602fa_Xc3.ms', interactive=False)
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X8602fa_Xc3.ms.sky')
  
  sdcal(infile = 'uid___A002_X8602fa_Xc3.ms',
    outfile = 'uid___A002_X8602fa_Xc3.ms.sky',
    calmode = 'otfraster')
  
  plotbandpass(caltable='uid___A002_X8602fa_Xc3.ms.sky', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='92.1875%',showfdm=True, 
    field='', figfile='uid___A002_X8602fa_Xc3.ms.sky.plots.overlayTime/uid___A002_X8602fa_Xc3.ms.sky') 
  
  if applyonly != True: es.checkCalTable('uid___A002_X8602fa_Xc3.ms.sky', msName='uid___A002_X8602fa_Xc3.ms', interactive=False)
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X8602fa_Xc3.ms',
    mode = 'manual',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_X8602fa_Xc3.ms', tsystable = 'uid___A002_X8602fa_Xc3.ms.tsys', trim = False)
  
  for i in ['0']:
    applycal(vis = 'uid___A002_X8602fa_Xc3.ms',
      applymode = 'calflagstrict',
      spw = '17,19,21,23',
      field = i,
      gaintable = ['uid___A002_X8602fa_Xc3.ms.tsys', 'uid___A002_X8602fa_Xc3.ms.sky'],
      gainfield = ['nearest', i],
      spwmap = tsysmap)
  
  if applyonly != True: es.SDcheckSpectra('uid___A002_X8602fa_Xc3.ms', msName='uid___A002_X8602fa_Xc3.ms', spwIds='17,19,21,23', interactive=False)
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X8602fa_Xc3.ms.cal')
  
  split(vis='uid___A002_X8602fa_Xc3.ms', outputvis='uid___A002_X8602fa_Xc3.ms.cal', datacolumn='corrected')
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X8602fa_Xc3.ms.nlc')

  gencal(vis='uid___A002_X8602fa_Xc3.ms.cal', caltable='uid___A002_X8602fa_Xc3.ms.nlc', caltype='amp', spw='', parameter=[to_amp_factor(1.25)])

  applycal(vis='uid___A002_X8602fa_Xc3.ms.cal', gaintable='uid___A002_X8602fa_Xc3.ms.nlc')
...
if(mystep in thesteps):
  ...
  for spw in ['17', '19', '21', '23']:
    ...
    for ant in ['PM03', 'PM04']:
      ...
      sdimaging(infiles = 'uid___A002_X8602fa_Xc3.ms.cal',
        field = '3c279',
        spw = spw,
        antenna = ant,
        nchan = 1,
        ...
        overwrite = True,
        outfile = 'uid___A002_X8602fa_Xc3.ms.cal.%s.spw%s.image' % (ant, spw))
...
if(mystep in thesteps):
  ...
  for ant in ['PM03', 'PM04']:
    ...
    for spw in ['17', '19', '21', '23']:
      ...
      if os.path.exists('uid___A002_X8602fa_Xc3.ms.cal.%s.spw%s.image' % (ant, spw)):
  
        peak = imstat('uid___A002_X8602fa_Xc3.ms.cal.%s.spw%s.image' % (ant, spw))['max'][0]
...
if(mystep in thesteps):
  ...
  asdm = 'uid___A002_X8602fa_Xc3'
  date = '2014-07-05T23:36:51'
  ampcal = '3c279'
  band = '3'
  ...
  elev = '66.0365388639' # mean elevation
  temp = '-11.4043537715' # mean temperature
  
  f = open('uid___A002_X8602fa_Xc3.ms.cal.jyperk.txt', 'w')
