...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_X86fcfa_X3ae.ms') == False:
    importasdm('uid___A002_X86fcfa_X3ae', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=True, lazy=False, process_caldevice=False, with_pointing_correction=True)
    os.system(os.environ['CASAPATH'].split()[0] + '/bin/bdflags2MS -f "COR DELA INT MIS SIG SYN TFB WVR ZER" uid___A002_X86fcfa_X3ae uid___A002_X86fcfa_X3ae.ms')
  if applyonly != True: es.fixForCSV2555('uid___A002_X86fcfa_X3ae.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X86fcfa_X3ae.ms.listobs')
  listobs(vis = 'uid___A002_X86fcfa_X3ae.ms',
    listfile = 'uid___A002_X86fcfa_X3ae.ms.listobs')
  
  if applyonly != True:
    aU.getTPSampling(vis = 'uid___A002_X86fcfa_X3ae.ms', showplot = True, plotfile = 'uid___A002_X86fcfa_X3ae.ms.sampling.png')
    for i in ['DV10', 'PM03', 'PM04']:
      aU.getTPSampling(vis = 'uid___A002_X86fcfa_X3ae.ms', antenna = i, showplot = True, plotfile = 'uid___A002_X86fcfa_X3ae.ms.sampling.'+i+'.png')
...
if(mystep in thesteps):
  ...
  flagcmd(vis = 'uid___A002_X86fcfa_X3ae.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_X86fcfa_X3ae.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X86fcfa_X3ae.ms.tsys')
  
  gencal(vis = 'uid___A002_X86fcfa_X3ae.ms',
    caltable = 'uid___A002_X86fcfa_X3ae.ms.tsys',
    caltype = 'tsys')
  
  plotbandpass(caltable='uid___A002_X86fcfa_X3ae.ms.tsys', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='92.1875%',showfdm=True, 
    field='', figfile='uid___A002_X86fcfa_X3ae.ms.tsys.plots.overlayTime/uid___A002_X86fcfa_X3ae.ms.tsys') 
  
  if applyonly != True: es.checkCalTable('uid___A002_X86fcfa_X3ae.ms.tsys', msName='uid___A002_X86fcfa_X3ae.ms', interactive=False)
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X86fcfa_X3ae.ms.sky')
  
  sdcal(infile = 'uid___A002_X86fcfa_X3ae.ms',
    outfile = 'uid___A002_X86fcfa_X3ae.ms.sky',
    calmode = 'otfraster')
  
  plotbandpass(caltable='uid___A002_X86fcfa_X3ae.ms.sky', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='92.1875%',showfdm=True, 
    field='', figfile='uid___A002_X86fcfa_X3ae.ms.sky.plots.overlayTime/uid___A002_X86fcfa_X3ae.ms.sky') 
  
  if applyonly != True: es.checkCalTable('uid___A002_X86fcfa_X3ae.ms.sky', msName='uid___A002_X86fcfa_X3ae.ms', interactive=False)
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X86fcfa_X3ae.ms',
    mode = 'manual',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_X86fcfa_X3ae.ms', tsystable = 'uid___A002_X86fcfa_X3ae.ms.tsys', trim = False)
  
  for i in ['0']:
    applycal(vis = 'uid___A002_X86fcfa_X3ae.ms',
      applymode = 'calflagstrict',
      spw = '17,19,21,23',
      field = i,
      gaintable = ['uid___A002_X86fcfa_X3ae.ms.tsys', 'uid___A002_X86fcfa_X3ae.ms.sky'],
      gainfield = ['nearest', i],
      spwmap = tsysmap)
  
  if applyonly != True: es.SDcheckSpectra('uid___A002_X86fcfa_X3ae.ms', msName='uid___A002_X86fcfa_X3ae.ms', spwIds='17,19,21,23', interactive=False)
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X86fcfa_X3ae.ms.cal')
  
  split(vis='uid___A002_X86fcfa_X3ae.ms', outputvis='uid___A002_X86fcfa_X3ae.ms.cal', datacolumn='corrected')
...
if(mystep in thesteps):
  ...
  os.system('rm -Rf uid___A002_X86fcfa_X3ae.ms.nlc')

  gencal(vis='uid___A002_X86fcfa_X3ae.ms.cal', caltable='uid___A002_X86fcfa_X3ae.ms.nlc', caltype='amp', spw='', parameter=[to_amp_factor(1.25)])

  applycal(vis='uid___A002_X86fcfa_X3ae.ms.cal', gaintable='uid___A002_X86fcfa_X3ae.ms.nlc')
...
if(mystep in thesteps):
  ...
  for spw in ['17', '19', '21', '23']:
    ...
    for ant in ['DV10', 'PM03', 'PM04']:
  
      sdimaging(infiles = 'uid___A002_X86fcfa_X3ae.ms.cal',
        field = '3c279',
        spw = spw,
        antenna = ant,
        nchan = 1,
        ...
        overwrite = True,
        outfile = 'uid___A002_X86fcfa_X3ae.ms.cal.%s.spw%s.image' % (ant, spw))
...
if(mystep in thesteps):
  ...
  srcflux = {}
  srcflux['17'] = 14.5377925501 # mean freq = 100.95
  srcflux['19'] = 14.3884708689 # mean freq = 102.76515
  srcflux['21'] = 13.6319100186 # mean freq = 112.80715
  srcflux['23'] = 13.5023418294 # mean freq = 114.68215
  ...
  for ant in ['DV10', 'PM03', 'PM04']:
    ...
    for spw in ['17', '19', '21', '23']:
      ...
      if os.path.exists('uid___A002_X86fcfa_X3ae.ms.cal.%s.spw%s.image' % (ant, spw)):
  
        peak = imstat('uid___A002_X86fcfa_X3ae.ms.cal.%s.spw%s.image' % (ant, spw))['max'][0]
...
if(mystep in thesteps):
  ...
  asdm = 'uid___A002_X86fcfa_X3ae'
  date = '2014-07-17T22:03:53'
  ampcal = '3c279'
  band = '3'
  ...
  elev = '71.8641506667' # mean elevation
  temp = '-3.88506733015' # mean temperature
  
  f = open('uid___A002_X86fcfa_X3ae.ms.cal.jyperk.txt', 'w')
